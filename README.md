...
| 功能                    | 状态      | 预计上线   | 价值                                       |
| ----------------------- | --------- | ---------- | ------------------------------------------ |
| **自定义 MCP 插件接入** | 🛠️ 开发中 | 2026 Q1    | 支持灵活扩展，打造专属工具链               |
| **知识库问答**          | 🛠️ 开发中 | 2026 Q1    | 基于团队私有文档精准问答                   |
| **多模态对话**          | 🛠️ 开发中 | 2026 Q1    | 支持图像、音频等输入输出                   |
| **内置 Function Call**  | 📅 计划中 | 2026 Q2    | 自动生成图表、PPT、代码等                  |
| **自动化工作流**        | 📅 计划中 | 2026 Q2–Q3 | 将 AI 融入业务上下文中，做更懂团队的助手。 |
