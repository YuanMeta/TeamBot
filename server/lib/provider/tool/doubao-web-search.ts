...
export const doubaoWebSearchArgsSchema = lazySchema(() =>
  zodSchema(
    z.object({
      filters: z
        .object({ allowedDomains: z.array(z.string()).optional() })
        .optional(),
      max_keyword: z.number().int().min(1).max(50).optional(),
      limit: z.number().optional(),
      sources: z.enum(['toutiao', 'douyin', 'moji']).array().optional(),
      userLocation: z
        .object({
